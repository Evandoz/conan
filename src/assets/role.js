const role = [
  {
    ...
    "desc": "由于不明原因不会衰老，曾经是美国女星莎朗·温亚德，朱蒂的杀父仇人，和工藤新一的母亲工藤有希子是好友，被工藤新一及毛利兰救过。后来Vermouth假造了自己的死亡，以莎朗的女儿克里斯·温亚德的身份活动。（A SECRET MAKES A WOMAN WOMAN）"
  },
  {
    "name": "伏特加",
  ...
  },
  {
    "name": "琴酒",
    "role": "组织成员，代号 Gin，琴酒",
    "desc": "一个人支撑着酒厂的运行，周围不是卧底，就是脑子不好使，或者各怀鬼胎"
  },
  {
    "name": "朗姆",
    "role": "组织成员，代号 Rum，朗姆",
    "desc": "地位在Gin之上，是一个重要人物。灰原听说了关于Rum的情报后告诉柯南Rum是组织的二把手，对其形象的描述众说纷纭，曾被描述成壮汉、像女人一样的男人和上了年纪的老人。Rum 因某次事故伤了眼睛，有一只眼是义眼。"
  },
  {
    "name": "宫野明美",
  ...
  },
  {
    "name": "伊森本堂",
    "role": "（CIA 卧底）组织成员",
    "desc": "身份暴露，掩护女儿本堂瑛海继续卧底二自杀"
  },
  {
    "name": "本堂瑛海",
    "role": "（CIA 卧底）组织成员，代号 Kir，化名水无怜奈",
    "desc": "CIA 成员，本堂瑛佑姐姐，伊森本堂女儿，电视台女主播。柯南在杯户中央医院（水无住院的医院）发现了假装患者住院的黑衣组织成员楠田陆道。不幸因FBI打草惊蛇，楠田陆道自杀身亡，尸体下落不明。Gin等人也因此推测出了水无住院的地点。在水无怜奈的住院地点暴露给组织之后，柯南、赤井和已经醒来的水无进行合作，让FBI探员安德烈·卡迈尔开车运送水无出医院，水无假装袭击卡迈尔，回到组织，以进一步取得组织信任。水无回到组织后，组织头目命令她杀害赤井秀一。水无成功枪杀了赤井，并引爆其尸体。尸体烧剩下的右手指纹通过与柯南手机上留下的指纹对比，证实死者是赤井秀一。本堂瑛祐拒绝了FBI的证人保护计划，推理出了柯南的真实身份，并且打算加入CIA与组织斗争。同时，柯南仿佛对赤井秀一“殉职”的消息并不感到惊慌。"
  },
  {
    "name": "羽田秀吉",
    "role": "",
    "desc": "日本将棋高手，赤井秀一的弟弟，世良真纯二哥，女警宫本由美男友。赤井秀一、羽田秀吉和世良真纯兄妹三人的母亲是英国人，名叫玛丽（Mary），也就是住在世良酒店房间中的“领域外的妹妹”，因某种原因吃了APTX4869导致身体变小。他们的父亲赤井务武好像在调查黑衣组织期间死亡，但没有找到尸体。"
  },
  {
    "name": "羽田浩司",
    "role": "",
    "desc": "羽田秀吉义兄，将棋棋手，在美国参加国际象棋大赛时因不明原因死亡。灰原回忆起她曾在服用过APTX4869的人的名单中看见过羽田浩司的名字。（850）柯南后来发现，羽田浩司的死亡与美国资本家阿曼达·修斯的死亡有关。羽田的房间里留有一个暗号，疑似表示阿曼达当时的保镖浅香（Asaca，Asaka）很可能就是Rum（朗姆），最新剧情显示（942），暗号并不是指 Asaca 和 Rum，而是指一个名字 CARASUMA 乌丸莲耶（219），疑似 BOSS 身份知晓。（注：乌丸的日语罗马音是KARASUMA，KA 与 CA 发音相同）。"
  },
  {
    "name": "玛丽",
    "role": "世良真纯母亲",
    "desc": "世良真纯称之为领域外的妹妹，实为其母亲，长得和灰原哀很像，有特工的身手及非一般的推理能力，也服了变小的药。"
  },
  {
    "name": "安德雷卡梅隆",
    "role": "FBI 探员",
    "desc": "FBI,两年前失误导致赤井秀一FBI身份暴露被迫离开组织，两年后再次失误使波本发现赤井秀一活着的事实。"
  }
]
