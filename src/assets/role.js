const role = [
  ...
  {
    "name": "羽田浩司",
    "role": "羽田秀吉义兄，将棋棋手，在美国参加国际象棋大赛时因不明原因死亡。灰原回忆起她曾在服用过APTX4869的人的名单中看见过羽田浩司的名字。（850）柯南后来发现，羽田浩司的死亡与美国资本家阿曼达·修斯的死亡有关。羽田的房间里留有一个暗号，疑似表示阿曼达当时的保镖浅香（Asaca，Asaka）很可能就是Rum（朗姆），最新剧情显示（942），暗号并不是指 Asaca 和 Rum，而是指一个名字 CARASUMA 乌丸莲耶（219），疑似 BOSS 身份知晓。（注：乌丸的日语罗马音是KARASUMA，KA 与 CA 发音相同）。",
    "desc": ""
  },
  {
    "name": "玛丽",
